...
class Player
{
	...
	int prison;                       // and reset again when reached 3
...
public:
	...
	int getplayernum() const ;     //getter for player num
	bool getprevent() const ; //getter for prevent
	int getprison()  ;
	void setprison(int );
	//==============================function for cards===========================
	//setting owner for the card
	void Cardowner(Player* cowner);
	void setprevent(bool prev); //prevent card
	void setPrevent();
	int getjustRolledDiceNum();
	void IamPrisoned(); //prison card
