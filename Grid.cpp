...
void Grid ::player0()
{
	while (GetCurrentPlayer()->getplayernum() !=0)
	{
		AdvanceCurrentPlayer(); //looping til reaching player 0
	}
}
...
void Grid ::setcurrPlayerNumber(int num){currPlayerNumber =num;}
int Grid:: GetNumLadder(){return NumLadder;}
int Grid:: GetNumSnakes(){return NumSnakes;}
int Grid:: GetNumCards(){return NumCards;}
void Grid::SetNums()
{
	for (int i = NumVerticalCells-1; i >= 0 ; i--) 
	{
